...
Module MS1TopDown
    ...
    Sub MS1CP(query As IEnumerable(Of Query))
        ...
        Pattern_n = 0
        Call MS1_CombinatorialPrediction(query)
                                    ...
                                    For Fer_n = NumFerMin To NumFerMax
                                        For Sin_n = NumSinMin To NumSinMax
                                            For DDMP_n = NumDDMPMin To NumDDMPMax
                                                ...
                                                Call MS1_CombinatorialPrediction_RestrictionCheck(Hex_n, HexA_n, dHex_n, Pen_n, Mal_n, Cou_n, Fer_n, Sin_n, DDMP_n, M_w)
    ...
    Sub MS1_CombinatorialPrediction_RestrictionCheck(Hex_n%, HexA_n%, dHex_n%, Pen_n%, Mal_n%, Cou_n%, Fer_n%, Sin_n%, DDMP_n%, M_w As Double)
   ...
   Mal_n * Mal_w + Cou_n * Cou_w + Fer_n * Fer_w + Sin_n * Sin_w + DDMP_n * DDMP_w
            ...
            If Bal >= AglyconeMWLL And Bal <= AglyconeMWUL Then
                Call MS1_CombinatorialPrediciton_InternalDatabase(M_w#, Attn_w#, nH2O_w#)
    ...
    Sub MS1_CombinatorialPrediciton_InternalDatabase(M_w#, Attn_w#, nH2O_w#)
        ...
        For Each ref As Library In library
            ...
            Call MS1_CombinatorialPrediciton_DatabaseSearch(AglyN:=ref.CommonName,
            AglyT:=ref.Class,
            AglyO:=ref.Genus,
            AglyW:=ref.ExactMass,
            AglyS:=ref.Universal_SMILES, M_w:=M_w, Attn_w:=Attn_w, nH2O_w:=nH2O_w)
    ...
    Sub MS1_CombinatorialPrediciton_DatabaseSearch(AglyN$, AglyT$, AglyO$, AglyW#, AglyS$, M_w#, Attn_w#, nH2O_w#)
